...
<head>
    <meta charset="utf-8">
    <title>
        @yield('title','Covid Smart Detection')
    </title>
        ...
        <!-- END Page Header -->
            ...
            <footer class="page-footer" role="contentinfo">
                <div class="d-flex align-items-center flex-1 text-muted">
                    <span class="hidden-md-down fw-700">2020 © Covid Smart Detection&nbsp;<a href='{{asset('/')}}' class='text-white opacity-40 fw-500' title='Smart Covid Predictor' target='_blank'></a></span>
                </div>
            </footer>
            <!-- END Page Footer -->
            <!-- BEGIN Shortcuts -->
